...
A single self-contained ES module, `src/index.js`, holds two formatters and a value humanizer and is published as-is to jslib.k6.io. There is no build step: k6 runs the module directly.
